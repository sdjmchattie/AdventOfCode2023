...
public abstract class GridDjikstraDataSource
{
...
public class GridDjikstra
{
    protected GridDjikstraDataSource DataSource;
    protected readonly PriorityQueue<GridDjikstraDataSource.Node, int> Unvisited = new();
    protected readonly HashSet<GridDjikstraDataSource.Node> Visited = [];

    public GridDjikstra(GridDjikstraDataSource dataSource)
    {
